...
describe("validateDocumentFile", () => {
  ...
  it("rejects an invalid extension, MIME mismatch, empty file, and oversized file", () => {
    expect(validateDocumentFile(file("contract.exe", "application/octet-stream"))).toContain("PDF와 TXT");
    ...
    expect(validateDocumentFile(file("large.pdf", "application/pdf", MAX_FILE_SIZE + 1))).toContain("10MB");
  });
});
